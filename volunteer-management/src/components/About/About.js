...
const about = () => {
    return(
        <div className={classes.About}>
            <h1>About Page</h1>
            <p>
                Hello love candy cane noel yule, carols celebration yule nutcracker nutcracker. Decorate frosty goodwill santa yule celebrate toys give. Gift Christmas stocking wreath singing chimney december december ornament.
